...
- Release key: `v0.5.105`
- Base URL: `http://localhost:8080`
- Path: [releases/v0.5.105/README.md](./releases/v0.5.105/README.md)
...
```sh
make docs-screenshots RELEASE=v0.5.105
make docs-screenshots-first-user RELEASE=v0.5.105
```
